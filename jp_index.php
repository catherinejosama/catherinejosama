    ...
    <section id="section_work">
      ...
      <div class="details_wrapper">
        <div class="details_box work_detail" id="work_detail">
          <a href="#" target="_blank"><img src="images/circus.png" style="width: 233px;"></a><br>
          <h2>Circus Roppongi</h2>
          <a href="#" target="_blank"><h3>もっとを見る</h3></a>
        </div>

        <div class="details_box work_detail" id="work_detail">
          <a href="#" target="_blank" ><img src="images/ezeebuy.png" style="width: 233px;"></a><br>
          <h2>EZEE Buy</h2>
          <a href="#" target="_blank" ><h3>もっとを見る</h3></a>
        </div>

        <div class="details_box work_detail" id="work_detail">
          <a href="#" target="_blank"><img src="images/giftedcafe.png" style="width: 233px;"></a><br>
          <h2>GFTD CAFE &amp; BAR</h2>
          <a href="#" target="_blank"><h3>もっとを見る</h3></a>
          </div>
        </div>
